...
class Dataset():
    ...
    def __init__(self,
            ...
            self.valdir = os.path.join(data_dir, 'test')
...
if __name__ == '__main__':
    ...
    data_dir = '/home/lingpeng/project/dataset/sketchyscene_copy1/data/val/DRAWING_GT'
    # get_train_loader(batch_size=10, world_size=0, device_id=0, data_dir=data_dir)