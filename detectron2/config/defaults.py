...
# are ignored (-1)
_C.MODEL.RPN.IOU_THRESHOLDS = [0.5, 0.7]
# _C.MODEL.RPN.IOU_THRESHOLDS = [0.3, 0.7]

# _C.MODEL.RPN.IOU_THRESHOLDS = [0.4, 0.5]
# _C.MODEL.RPN.IOU_THRESHOLDS = [0.4, 0.5]
_C.MODEL.RPN.IOU_LABELS = [0, -1, 1]
# Number of regions per image used to train RPN
# _C.MODEL.RPN.BATCH_SIZE_PER_IMAGE = 256
# _C.MODEL.RPN.BATCH_SIZE_PER_IMAGE = 64  # 调小效果好像好些
_C.MODEL.RPN.BATCH_SIZE_PER_IMAGE = 256

# _C.MODEL.RPN.BATCH_SIZE_PER_IMAGE = 48
# _C.MODEL.RPN.BATCH_SIZE_PER_IMAGE = 32
...
_C.MODEL.RPN.NMS_THRESH = 0.5 # 调低
...
_C.MODEL.ROI_HEADS.NUM_CLASSES = _C.MODEL.NUM_CLASSES
...
# _C.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 256  # 每幅图像中，在所有的proposal中采样固定个数个送入ROI，正负样本均有
# _C.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 64
# _C.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 32
...
_C.MODEL.ROI_HEADS.SCORE_THRESH_TEST = 0.1
...
# 如果使用GCN，那么这个地方最好再添加两个卷积
_C.MODEL.ROI_BOX_HEAD.NUM_CONV = 4
##########################################
...
_C.MODEL.ROI_BOX_HEAD.NORM = "BN"
# _C.MODEL.ROI_BOX_HEAD.NORM = "SyncBN"
...
# _C.MODEL.ROI_MASK_HEAD.NORM = "SyncBN"
...
_C.MODEL.SEM_SEG_HEAD.NUM_CLASSES = _C.MODEL.NUM_CLASSES
...
_C.MODEL.RETINANET.NUM_CLASSES = _C.MODEL.NUM_CLASSES
...
_C.MODEL.RESNETS.NUM_GROUPS = 2

# Options: FrozenBN, GN, "SyncBN", "BN"
# _C.MODEL.RESNETS.NORM = "FrozenBN"
_C.MODEL.RESNETS.NORM = "BN"
# _C.MODEL.RESNETS.NORM = "SyncBN"

# _C.MODEL.RESNETS.NORM = "GN"
...
_C.SOLVER.LR_SCHEDULER_NAME = "WarmupMultiStepLR" # WarmupCosineLR
# _C.SOLVER.LR_SCHEDULER_NAME = "WarmupCosineLR" # WarmupCosineLR
